...
public class EncryptEx_02 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
         ...
         * List<> ArrayList<>
         *
         * Map<> type 의 데이터는 Collection(다수의 데이터를 포함하는 데이터) 이지만
         * Literal 이 아니다
         * 그래서 Map 에 담긴 데이터를 foreach() 등으로 확인할 수 없다
         *
         * Map 에 담긴 데이터를 foreach() 로 연산 하고자 할때는
         * 1. Map 의 key 값을 추출하여 Set 데이터로 변환한다
         *      Map 에서 제공하는 keySet() method 를 사용하여
         *      key 들만 별도로 추출하여 Set 데이터로 변환할수 있다.
        ...
        // 시스템 환경변수 중 callor.com 변수의 값을 추출(getter)하여
        // salt 변수에 담는다
